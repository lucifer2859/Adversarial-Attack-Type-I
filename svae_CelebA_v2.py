...
encoder, generator, classifier, discriminator = CelebA_model_v2.build_CelebA_Model(dim_z)
...
# =============================== TRAINING ====================================
    ...
    x_train, y_train, x_test, y_test = CelebA_data.load_celebA_Attr()
    print('done!')
    ...
    if stage_flag[0]:
        ...
        for epoch in range(pretrain_epoch_num[0] + 1, epoch_num[0] + 1):
            ...
            for i in range(total_train_batch):
                ...
                # Loss
                classify_loss = -torch.mean(y * torch.log(torch.sigmoid(y_hat)) + (1 - y) * torch.log(1 - torch.sigmoid(y_hat)))
...
# =============================== Stage2 TRAINING =============================
    ...
    _, _, x_test, y_test = CelebA_data.load_celebA_Attr(test_only=True)
