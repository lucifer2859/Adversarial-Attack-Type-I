...
output_path = "/home/dchen/dataset/CelebA/gender/"
image_path = "/home/dchen/dataset/CelebA/Img/img_align_celeba"
CelebA_Attr_file = "/home/dchen/dataset/CelebA/Anno/list_attr_celeba.txt"
Attr_type = 21 # Male

def main():
    '''Divide face accordance CelebA Attr male label.'''
    trainA_dir = os.path.join(output_path, "male")
    trainB_dir = os.path.join(output_path, "female")
